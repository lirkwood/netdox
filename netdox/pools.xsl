<xsl:stylesheet version="3.0"
  ...
  <xsl:variable name="devices" select="json-to-xml(unparsed-text('../src/pools.json'))"/>
  ...
  <xsl:template match="xpf:array/xpf:map">
    ...
    <xsl:result-document href="../out/pools/{translate($label,'.','_')}.psml" method="xml" indent="yes">
